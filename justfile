...
start-testnet:
    pm2 start neurons/miner.py --interpreter python3 --name TM1 -- --actual_batch_size 6 --wallet.name Bistro --wallet.hotkey M111 --device cuda:0 --use_wandb --autoupdate --process_name TM1 --project gonso-1 --netuid 223 --test 
    pm2 start neurons/miner.py --interpreter python3 --name TM2 -- --actual_batch_size 6 --wallet.name Bistro --wallet.hotkey M222 --device cuda:1 --use_wandb --autoupdate --process_name TM2 --project gonso-1 --netuid 223 --test 
    pm2 start neurons/validator.py --interpreter python3 --name TV1 -- --actual_batch_size 6 --wallet.name Bistro --wallet.hotkey V11 --device cuda:2 --use_wandb --autoupdate --process_name TV1 --project gonso-1 --netuid 223 --test 
