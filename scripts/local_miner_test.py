...
argp.add_argument(
    ...
    type=int,
    default=500,
    help="Number of Miner.inner_steps() windows to run",
)
...
class _FakeComms:
    ...
    def get_own_bucket(self, *_, **__):
        return None

    def try_commit(self, *_, **__):
        pass
...
tplr.initialize_wandb = lambda *_a, **_k: types.SimpleNamespace(
