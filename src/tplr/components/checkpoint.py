...
from tplr.components.ft import FTManager
from tplr.components.lr_scheduler import LRSchedulersContainer
from tplr.components.optimizer import OptimizersContainer
from tplr.config_manager import JobConfig, TORCH_DTYPE_MAP
from tplr.tools.logging import init_logger, logger
from tplr.tools.utils import GarbageCollection
...
class CheckpointManager:
    ...
    def _save_last_step(self, curr_step: int) -> None:
        ...
        if self.model_weights_only:
            ...
            # Context: https://github.com/pytorch/tplr/blob/main/tplr/models/llama/model.py#L348
