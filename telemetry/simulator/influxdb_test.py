...
def test_influxdb_integration():
    ...
    parser.add_argument("--role", type=str, choices=["miner", "validator"], default="miner", help="Role to test")
    ...
    print("Logged test metric to InfluxDB. If no errors occurred, the integration is working.")
