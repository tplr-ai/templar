...
#     manager.get_temp_dir = MagicMock(return_value="/tmp/test")
#     return manager

# @pytest.fixture(scope="function")
# async def comms_instance(mock_wallet, mock_metagraph, mock_storage_client, mock_file_manager):
#     with patch('tplr.comms.StorageClient', return_value=mock_storage_client), \
#          patch('tplr.comms.FileManager', return_value=mock_file_manager):
